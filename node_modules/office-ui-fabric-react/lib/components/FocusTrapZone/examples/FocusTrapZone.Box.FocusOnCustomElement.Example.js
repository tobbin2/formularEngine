...
var FocusTrapZoneBoxCustomElementExample = /** @class */ (function (_super) {
    ...
    FocusTrapZoneBoxCustomElementExample.prototype.render = function () {
        return (React.createElement("div", null, this.state.useTrapZone ? (React.createElement(FocusTrapZone, { firstFocusableSelector: _focusClassName }, this._internalContents())) : (this._internalContents())));
    };
