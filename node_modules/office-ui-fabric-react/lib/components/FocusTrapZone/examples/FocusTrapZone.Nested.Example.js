...
var FocusTrapComponent = /** @class */ (function (_super) {
    ...
    FocusTrapComponent.prototype.render = function () {
        ...
        var contents = (React.createElement(Stack, { horizontal: zoneNumber === 2, horizontalAlign: "start", tokens: { childrenGap: 10 }, styles: {
                root: { border: "2px solid " + (isActive ? '#ababab' : 'transparent'), padding: 10 }
            } },
            React.createElement(Toggle, { defaultChecked: isActive, onChange: this._onFocusTrapZoneToggleChanged, label: 'Enable trap zone ' + zoneNumber, onText: "On (toggle to exit)", offText: "Off", styles: {
