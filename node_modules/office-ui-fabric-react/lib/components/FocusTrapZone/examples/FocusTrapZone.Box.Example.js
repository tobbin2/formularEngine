...
var FocusTrapZoneBoxExample = /** @class */ (function (_super) {
    ...
    FocusTrapZoneBoxExample.prototype.render = function () {
        return (React.createElement("div", null, this.state.useTrapZone ? (React.createElement(FocusTrapZone, null, this._internalContents())) : (
        // prettier-ignore
        this._internalContents())));
    };
    FocusTrapZoneBoxExample.prototype._internalContents = function () {
