    ...
    function List(props) {
        ...
        _this._onRenderPage = function (pageProps, defaultRender) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                cells.push(React.createElement("div", { role: cellRole, className: css('ms-List-cell'), key: itemKey, "data-list-index": index, "data-automationid": "ListCell" }, onRenderCell && onRenderCell(item, index, _this.state.isScrolling)));
            }
