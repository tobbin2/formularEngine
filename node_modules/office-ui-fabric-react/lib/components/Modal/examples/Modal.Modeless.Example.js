...
var ModalModelessExample = /** @class */ (function (_super) {
    ...
    ModalModelessExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: this.state.showModal, onDismiss: this._closeModal, isModeless: true, containerClassName: styles.stickyContainer },
