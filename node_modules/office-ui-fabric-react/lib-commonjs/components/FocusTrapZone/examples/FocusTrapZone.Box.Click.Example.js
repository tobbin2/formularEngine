...
var FocusTrapZoneBoxClickExample = /** @class */ (function (_super) {
    ...
    FocusTrapZoneBoxClickExample.prototype.render = function () {
        return (React.createElement("div", null, this.state.useTrapZone ? (React.createElement(FocusTrapZone_1.FocusTrapZone, { isClickableOutsideFocusTrap: true, forceFocusInsideTrap: false }, this._internalContents())) : (this._internalContents())));
    };
