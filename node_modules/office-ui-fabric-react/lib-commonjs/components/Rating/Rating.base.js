...
var RatingBase = /** @class */ (function (_super) {
    ...
    RatingBase.prototype.render = function () {
        ...
        return (React.createElement("div", { className: Utilities_1.css('ms-Rating-star', this._classNames.root, (_e = {},
                ...
                _e)), "aria-label": getAriaLabel ? getAriaLabel(this.state.rating ? this.state.rating : 0, this.props.max) : '', id: id },
