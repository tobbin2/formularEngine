    ...
    var VerticalStackWrapNestedExample = /** @class */ (function (_super) {
        ...
        VerticalStackWrapNestedExample.prototype.render = function () {
            ...
            return (React.createElement(Stack_1.Stack, { tokens: tokens.sectionStack },
                ...
                React.createElement(Stack_1.Stack, { wrap: true, tokens: tokens.wrapStack, className: styles.root },
                    React.createElement(Stack_1.Stack, { wrap: true, tokens: tokens.firstStack, className: styles.stackOne },
                    ...
                    React.createElement(Stack_1.Stack, { wrap: true, tokens: tokens.secondStack, className: styles.stackTwo },
                        React.createElement("span", null, "1"),
                        React.createElement("span", null, "2"),
                        React.createElement("span", null, "3")),
